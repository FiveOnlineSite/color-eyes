...
const audiences = [
  { title: "Consumer", copy: "Comfortable lens solutions made for daily wear, clear vision and effortless self-expression.", icon: "audience-consumer-animated-80.gif" },
  ...
  { title: "Optical Retailers", copy: "A dependable range designed to help retailers serve varied customer needs with confidence.", icon: "audience-retailer-animated-80.gif" },
  { title: "Distributors & Resellers", copy: "Comfortable lens solutions made for daily wear, clear vision and effortless self-expression.", icon: "audience-distributo-animated-80.gif" },
];
