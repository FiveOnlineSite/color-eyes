    ...
    >
      ...
      <div className="relative z-[2] flex flex-col items-center max-[640px]:w-full">
        ...
        <div className="mt-12 flex gap-[18px] max-[640px]:mt-9 max-[640px]:flex-col">
          <ActionLink className="max-[640px]:self-center" href="mailto:admin@coloreyes.com" variant="light">Contact Us</ActionLink>
          <ActionLink className="max-[640px]:self-center" href="tel:+919876543210" variant="outline">Talk to Our Team</ActionLink>
        </div>
      </div>
    </section>
  );
