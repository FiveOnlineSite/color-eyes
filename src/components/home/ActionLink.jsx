...
export default function ActionLink({ children, href = "#", variant = "teal" }) {
  ...
  return (
    ...
    >
      <span>{children}</span>
      <span
        className={`grid size-[46px] place-items-center rounded-full max-[640px]:size-10 ${iconVariants[variant]}`}
      >
        <Image
          className="size-[18px]"
